...
<body style='font-family: Helvetica,sans-serif'>
	<div style=''>
		...
		<div style='background:#E4D4CA;padding:2em;'>
			...
			Please click the link below to verificate your account.<br/>
			Thanks for your choosing Concrete products.<br/>
		</div>
	</div>
	<footer style='background: #231B16;color:white; height:3em'>
		<div style='position:relative;width:100%;height:4em'> <!-- Start footer menu. -->
   			<div style='position:absolute;right:1em; bottom:2em;font-size:0.8em'>2015 The Concrete Protector</div>
 		</div>
 	</footer>
</body>
