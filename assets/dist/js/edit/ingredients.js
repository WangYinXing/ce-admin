...
$(function() {
  $(document).ready(function(evt) {
     $("#save_form").submit(function(event) {
        ...
        if (!validate("input[name='coverage']", "currency", "Please coverage correctly.")) { event.preventDefault(); return;}
        if (!validate("input[name='purchaseprice']", "currency", "Please purchase price correctly.")) { event.preventDefault(); return;}
